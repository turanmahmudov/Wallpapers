...
UBUNTU_TRANSLATION_DOMAIN="wallpapers.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/Wallpapers/tests/autopilot/run
aptest.depends  = sub-Wallpapers

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Wallpapers/tests/unit
unittest.depends  = sub-Wallpapers
